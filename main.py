...
class MainWindow(QMainWindow):
    ...
    def generate_help_text(self):
        ...
        """.format(resource_path('public/logo.png').replace('\\', '/'))


# if __name__ == "__main__":
#     import multiprocessing
#
#     # 【极度重要】Windows 下使用 ProcessPoolExecutor 多进程，必须加这一行！
#     multiprocessing.freeze_support()
#
#     app = QApplication(sys.argv)
#
#     # ================= 1. 极速创建并显示启动闪屏 (Splash Screen) =================
#     from PyQt5.QtWidgets import QSplashScreen
#     from PyQt5.QtGui import QPixmap, QPainter, QColor
#
#     # 动态绘制一个高级深色启动牌（不依赖外部图片，保证 0 延迟弹出）
#     splash_pix = QPixmap(560, 320)
#     splash_pix.fill(QColor("#000823"))  # 经典高级灰蓝底色
#
#     painter = QPainter(splash_pix)
#     painter.setRenderHint(QPainter.Antialiasing)
#
#     # 画主标题
#     painter.setPen(QColor("#e2faff"))
#     painter.setFont(QFont("Microsoft YaHei", 26, QFont.Bold))
#     painter.drawText(0, -30, 560, 320, Qt.AlignCenter, "PDF 聚合工作站")
#
#     # 画版本号与副标题
#     painter.setPen(QColor("#3c4f70"))
#     painter.setFont(QFont("Microsoft YaHei", 14, QFont.Bold))
#     painter.drawText(0, 30, 560, 320, Qt.AlignCenter, "V 2.1 Professional Edition")
#     painter.drawText(0, 70, 560, 320, Qt.AlignCenter, "玄宇绘世设计工作室出品")
#     painter.end()
#
#     # 置顶显示闪屏
...
#     splash.show()
#
#     # 【关键】强制刷新系统 UI，让闪屏立刻上屏，不等后面的耗时加载
#     app.processEvents()
#
#     # ================= 2. 闪屏渲染后，开始加载重型资源 =================
#     splash.showMessage("正在加载底层 PDF 渲染引擎与 OCR 模块...", Qt.AlignBottom | Qt.AlignCenter, QColor("#BDC3C7"))
#     app.processEvents()
#
#     # 设置图标与全局样式
#     icon_path = resource_path('logo.ico')
...
#
#     splash.showMessage("正在初始化图形界面...", Qt.AlignBottom | Qt.AlignCenter, QColor("#BDC3C7"))
#     app.processEvents()
#
#     # 初始化最耗时的主窗口
#     window = MainWindow()
#
#     # ================= 3. 加载完毕，平滑切换 =================
#     splash.finish(window)  # 主窗口渲染好后，关闭闪屏
#     window.show()
#
#     sys.exit(app.exec_())
